        ...
        <div className="mt-5">
            <footer className="footer p-10 bg-base-200 text-base-content">
                <nav>
                    ...
                    {
                        services.map((service, index) => <Link to={`/details/${service?.id}`} key={index} className="link link-hover">{service?.name}</Link>)
                    }
                </nav>
                <nav>
            ...
            <footer className="footer px-10 py-4 border-t bg-base-200 text-base-content border-base-300">
                <aside className="items-center grid-flow-col">
                    ...
                    <p>Alpha event management Ltd. <br />Providing reliable event management since 2001</p>
                </aside>
